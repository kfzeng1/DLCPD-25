...
DEFAULT_CLASSES = REPO_ROOT / "metadata" / "dlcpd25" / "official-class-names.txt"
DEFAULT_ALIASES = REPO_ROOT / "metadata" / "dlcpd25" / "class-directory-aliases.json"
DEFAULT_DATA = REPO_ROOT / "data" / "raw" / "dlcpd25"
DEFAULT_JSON = REPO_ROOT / "metadata" / "dlcpd25" / "class-taxonomy.json"
DEFAULT_CSV = REPO_ROOT / "metadata" / "dlcpd25" / "class-taxonomy.csv"
...
def write_metadata(records: list[dict[str, object]], json_path: Path, csv_path: Path) -> None:
    ...
    payload = {
        "schema_version": 2,
        "class_id_rule": "Zero-based order in metadata/dlcpd25/official-class-names.txt.",

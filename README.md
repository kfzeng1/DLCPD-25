...
- 项目采用“宿主作物 → 五大标签属性 → 具体标签”的层级：当前 22 个宿主下再分农业有害生物、植物病害、健康、非生物/生理缺陷、混合歧义五类。
...
data/
  ...
  views/by-host/               # 宿主/五大类/具体标签软链接视图
docs/
...
审计退出码为 `0` 表示 203 个官方类别全部存在、非空且没有额外类别。训练时以 203 个细粒度类别为最终标签，宿主和五大类可用于级联分类、界面筛选及分层评估。
